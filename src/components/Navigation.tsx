import { Shield, Calendar, Users, Bell, Settings, BarChart3, FileText, Activity, Heart, DollarSign, Hospital, Database, Zap, Droplets, History, PenTool, UserCheck, Package, Clock } from "lucide-react";
...
export const Navigation = ({ activeTab, onTabChange }: NavigationProps) => {
  ...
  const navItems = [
    ...
    { id: "shift-logging", label: "Shift Logging", icon: Clock },
